...
//What does asyncronous mean = opp to syncronous , hapens in parts , multiple thins are context switching ith each other.
...
findSum(100);
//When we run this function the js thread is busy running it . 1st when the program is executed the control reaches line 9 and the jups to line 16 . After line 16 contol goes back to line 10 and then the for loops is being processed n times making the threads busy doing these calculations and not free . This is a syncronous function 
...
//In this example we observe that instead of waiting in line 30 for a second and executing it , context switching happens and the control reaches next line and executes it , by that time 1sec happens and then the settimeout function is exected . 
